...
describe('isPermutation', () => {
  ...
  test.each([null, undefined, [], {}, () => true, 123])('throws if input1 is not a string', (input1) => {
    expect(() => isPermutation(input1, 'a string')).toThrow(`input1 is ${typeof input1} but should be a string`);
  });

  test.each([null, undefined, [], {}, () => true, 123])('throws if input2 is not a string', (input2) => {
    expect(() => isPermutation('a string', input2)).toThrow(`input2 is ${typeof input2} but should be a string`);
  });
